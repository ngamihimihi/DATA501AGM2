...
RcppExport SEXP _DATA501AGM2_e_step_general_impute(SEXP dataSEXP, SEXP muSEXP, SEXP SigmaSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _DATA501AGM2_log_likelihood_mvnorm(SEXP dataSEXP, SEXP muSEXP, SEXP SigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type data(dataSEXP);
...
RcppExport SEXP _DATA501AGM2_m_step_estimate(SEXP imputed_dataSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_DATA501AGM2_e_step_general_impute", (DL_FUNC) &_DATA501AGM2_e_step_general_impute, 3},
    {"_DATA501AGM2_log_likelihood_mvnorm", (DL_FUNC) &_DATA501AGM2_log_likelihood_mvnorm, 3},
    {"_DATA501AGM2_m_step_estimate", (DL_FUNC) &_DATA501AGM2_m_step_estimate, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_DATA501AGM2(DllInfo *dll) {
